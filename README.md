...
- **👥 Clients** — fichier clients avec nom, téléphone, email, notes, points fidélité, consentement offres + **statistiques par client** (nb de passages, panier moyen, délai moyen entre 2 passages, total dépensé, prestation favorite)
- **⭐ Fidélité** — programme points configurable avec récompenses ; **enregistrement d'un passage** en cochant les prestations payées (le tarif des prestations alimente le panier moyen)
